                ...
                <td>
                    ...
                    <div class="btn-group" role="group">
                        ...
                        <div class="dropdown-menu">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('movie.edit')): ?>
                                <a class="dropdown-item" onclick="showMovieEditModel(event)"
                                    href="<?php echo e(route('movie.edit', $row->id)); ?>">Edit</a>
                            <?php endif; ?>

                            <?php if($row->is_active == 'Y'): ?>
                                <a class="dropdown-item" href="<?php echo e(route('movie.status', $row->id)); ?>">Inactive</a>
                            <?php else: ?>
                                <a class="dropdown-item" href="<?php echo e(route('movie.status', $row->id)); ?>">Active</a>
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('movie.destroy')): ?>
                                <a class="dropdown-item"
                                    onclick="if(confirm('Are you sure you want to delete.')) document.getElementById('delete-<?php echo e($row->id); ?>').submit()">
                                    Delete</a>
                                <form id="delete-<?php echo e($row->id); ?>" action="<?php echo e(route('movie.destroy', $row->id)); ?>"
                                    method="POST">
...
<?php /**PATH D:\OSPanel\domains\karmamediaent.com\www\resources\views/admin/movie/table.blade.php ENDPATH**/ ?>