...
<?php $__env->startSection('section'); ?>
    ...
    <div class="radiusdiv">
        <div class="mainimg"><img src="<?php echo e(asset('assets/frontend/images/news-big-img.jpg')); ?>"
                alt="" /></div>
        <div class="sliderimg"><img src="<?php echo e(asset('assets/frontend/images/slider-bg.png')); ?>"
                alt="" />
        </div>
    </div>
    <!-- home slider div end -->
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OSPanel\domains\karmamediaent.com\www\resources\views/frontend/news.blade.php ENDPATH**/ ?>