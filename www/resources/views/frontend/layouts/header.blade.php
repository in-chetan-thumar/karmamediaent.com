<div class="header">
    <nav class="navbar navbar-expand-lg navbar-light"> <a class="navbar-brand" href="{{ route('frontend.home') }}"><img
            ...
            <ul class="navbar-nav mr-0">
                ...
                <li class="nav-item dropdown ">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item " href="{{ route('frontend.movies') }}">Movies</a>
                        <a class="dropdown-item " href="{{ route('frontend.webseries') }}">Webseries</a>
                    </div>
                </li>
                <li class="nav-item ">
